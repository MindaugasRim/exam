...
export class BookList extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://localhost:8080/customers/weight")
    .then(res => { 
      console.log(res);
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Grid item xs={12} >
        <div className="hs"> Report by order weight </div> 
        </Grid>
          ...
          <Table  className="bm80 " >
            ...
            <TableHead className="ts">
              <TableRow  className="ts"> 
                ...
                <TableCell > <p className="ts">Register Inventor (weight) </p> </TableCell>
